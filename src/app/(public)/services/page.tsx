...
const PROCESS = [
  { step: '01', title: 'Book Online or Call', desc: 'Submit your request below or call +356 7966 1889. Appointment confirmed within 24 hours.' },
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-3 mb-10">
                  {[
                    ...
                    { icon: Award,  label: 'F-Gas Certified',     sub: 'All technicians' },
                    { icon: Shield, label: 'Professional Service', sub: 'Residential & commercial' },
              ...
              <div>
                ...
                <div className="mb-5 flex items-center gap-3 px-5 py-4 rounded-2xl bg-red-50 border border-red-200">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-bold text-red-800">AC Emergency?</p>
                    <p className="text-xs text-red-600">Don&apos;t fill this form — call us now for same-day dispatch.</p>
                  </div>
                  <a href="tel:+35679661889" className="shrink-0 px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-bold rounded-xl transition-colors">
                    Call Now
                  </a>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-slate-100 shadow-[0_4px_40px_-12px_rgba(0,0,0,0.08)] p-8">
                  ...
                  <p className="text-sm text-slate-500 mb-1">
                    We&apos;ll confirm your appointment within 24 hours during business hours.
                  </p>
                  <p className="text-xs text-slate-400 mb-7">
                    Mon–Fri 08:00–18:00 · Sat 08:00–14:00 · Sun: Closed
                  </p>
                  <ServiceRequestForm />
                </div>
                ...
                <a href="https://wa.me/35679661889" target="_blank" rel="noopener noreferrer"
                  className="mt-4 flex items-center gap-3 px-5 py-4 rounded-2xl bg-green-50 border border-green-200 hover:bg-green-100 transition-colors">
