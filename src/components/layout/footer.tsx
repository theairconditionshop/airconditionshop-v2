        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="tel:+35679661889" className="flex items-center gap-2.5 text-slate-400 hover:text-blue-400 transition-colors cursor-pointer">
                  <Phone className="w-4 h-4 shrink-0 text-blue-500" />
                  +356 7966 1889
                </a>
              </li>
              <li>
                <a href="mailto:support@theairconditionshop.com" className="flex items-center gap-2.5 text-slate-400 hover:text-blue-400 transition-colors cursor-pointer">
            ...
            <div className="flex items-center gap-3 mt-6">
              <a href="https://facebook.com/theairconditionshop" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 flex items-center justify-center rounded-lg bg-slate-800 text-slate-400 hover:bg-blue-600 hover:text-white transition-all duration-200 cursor-pointer">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {PRODUCT_LINKS.map(link => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-slate-400 hover:text-blue-400 transition-colors cursor-pointer">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            {/* Trade CTA — prominent block */}
            <div className="mt-6 bg-amber-500/10 border border-amber-500/30 rounded-xl p-5">
              <p className="text-sm font-bold text-amber-400 mb-1">Trade Programme</p>
              <p className="text-xs text-slate-400 mb-4">Exclusive pricing for installers &amp; contractors</p>
