                    ...
                    <div className="flex flex-wrap gap-2 mb-8">
                      {['9000 BTU', '12000 BTU', '18000 BTU', 'Heat Pump', 'Inverter', 'Split System', 'VRF'].map(term => (
                        <button
                          ...
                          className="px-3 py-2 text-sm text-slate-600 bg-slate-50 hover:bg-blue-50 hover:text-blue-600 rounded-xl border border-slate-100 transition-colors cursor-pointer"
                        >
                          {term}
                        </button>
                      ))}
