...
export default function BtuPromo() {
  return (
    <section className="relative py-14 lg:py-20 bg-slate-950 overflow-hidden">
          ...
          >
            <div className="relative aspect-[4/3] lg:aspect-[5/4] overflow-hidden rounded-3xl">
              <Image
                ...
                alt="Modern living room — the right air conditioner makes all the difference"
                fill
              ...
              <div className="absolute bottom-5 left-5 right-5">
                <div className="inline-flex items-center gap-4 bg-slate-950/80 backdrop-blur-md border border-white/10 rounded-2xl px-5 py-3.5">
                  ...
                  <div className="ml-1 text-[11px] text-slate-500 leading-tight hidden sm:block">
                    20 m² room<br />example
                  </div>
                </div>
              </div>
            </div>
